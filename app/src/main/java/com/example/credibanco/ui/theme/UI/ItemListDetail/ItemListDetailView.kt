...
@Composable
fun ItemListDetailView(receiptId: String, statusDescription: String, rrn: String, ItemListDetaiViewModel: ItemListDetaiViewModel) {
    ...
    Column(
        ...
        ModalContent(receiptId, rrn, ItemListDetaiViewModel)
    }
}
...
@Composable
fun ModalContent(receiptId: String, rrn: String, ItemListDetaiViewModel: ItemListDetaiViewModel) {
        ...
        ExtendedFloatingActionButton(onClick = { openBottomSheet = !openBottomSheet }, modifier = Modifier.padding(vertical = 50.dp)) {
            ...
            if (openBottomSheet) {
                ...
                ModalBottomSheet(
                    ...
                    CancellationScreen(receiptId, rrn, ItemListDetaiViewModel)
                }
            }
        }
    }
